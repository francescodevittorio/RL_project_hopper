...
num_simopt_iterations = 3  # Cambia
real_batch_size = 4
...
# Funzione principale per eseguire la grid search
def grid_search():
    ...
    with open('generated_params.csv', mode='w', newline='') as params_file, \
        ...
        for lr_G in learning_rates:
            for lr_D in learning_rates:
                # Inizializzazione di wandb per ogni combinazione
                ...
                model = PPO.load("./logs_safe/best_model.zip")
