...
def train_best_model():
    wandb.init(project='best_model_training', name='prova da cancellare', monitor_gym=True)
    ...
    model.save("bestPPO_model_source_last_1")
    wandb.save("bestPPO_model_source_last_1.zip")
